...
# initialize trees
dev_tree = BTree(index_file='data/develop/indexes/Team', num_children=10)
dev_tree_bin = BTree(index_file='data/develop/indexes/Team', num_children=10, binary=True)
